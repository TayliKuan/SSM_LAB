...
<body>
  <div class='wrapper'>
    ...
    <div class="container">
  		<form:form method="post" action="insert.action" modelAttribute="empDoMain">
		...
		<tr>
			...
			<td>
				<form:select path="deptno">
					<form:options items="${requestScope.dept}" itemValue="deptno" itemLabel="dname" />
				</form:select> 
			</td>
		</tr>
	</table>
<input type="submit" value="送出新增" class="btn btn-outline-dark btn-block">
</form:form>
    </div>
</div>
</body>
