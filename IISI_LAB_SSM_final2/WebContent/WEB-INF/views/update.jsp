    ...
    <form action="update" method="post">
        <table class="table table-striped table-sm">
            ...
            <tr>
                ...
                <td><input type="date" name="birthday" class="form-control" placeholder="請輸入姓名" value="${aUser.birthday}"required> </td>
            </tr>
            <tr>
                <td class="text-center">加入日期：</td>
                <td><input type="date" name="joindate" class="form-control" placeholder="請輸入姓名" value="${aUser.joindate}"required></td>
            </tr>
            <tr>
                <td colspan="2">
