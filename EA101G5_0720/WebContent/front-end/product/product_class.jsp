...
//從session來的東西
List<ProductVO> productVOlist = (List<ProductVO>) session.getAttribute("productVOlist");
			...
			<div class="row">
				...
				<div class="col-12 col-md-8 col-lg-9">
					<div class="shop_grid_product_area">
						...
						<c:forEach var="productVO" items="${productVOlist}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
...
<%-- 				<c:forEach var="saleitems" items="${salemap}" > --%>
<%-- 				<c:if test="${saleitems.key == productVO.prodno}">  --%>
<%-- 				<p class="product-price">${productVO.prodprice}</p></c:if> --%>
<%-- 				</c:forEach> --%>
<!-- Hover Content -->
