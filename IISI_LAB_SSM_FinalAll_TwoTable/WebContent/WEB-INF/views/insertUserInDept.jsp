...
<body>
 <div class='wrapper'>
    ...
    <div class="container">
 <!-- ------------------------------------------------form:form 開始------------------------------------------------ -->
    <form:form action="saveUser.action" method="post" modelAttribute="user">
...
<!--             <td class="text-center" >部門：</td> -->
                <td><form:input path="deptno" type="hidden" name="deptno" class="form-control" value="${deptno}" /></td>
<%--                 <td class="form-control">${deptno}</td> --%>
<%--                  <td><form:errors path="deptno" style="color:red"></form:errors></td> --%>
            </tr>
            <tr>
                <td colspan="2">
                <form:button  name="action" type="submit" value="saveUser" class="btn btn-outline-dark btn-block">送出新增</form:button>
