...
<body>
 <div class='wrapper'>
    ...
    <div class="container">
 <!-- ------------------------------------------------form:form 開始------------------------------------------------ -->
    <form:form action="updateOneUser.action" method="post" modelAttribute="user">
        <table class="table table-striped table-sm">
            <tr>
                <td class="text-center">客戶編號：${user.uno}</td>
                <td></td>
            </tr>
            <tr>
                <td class="text-center">客戶姓名：</td>
                <td><form:input path="username" type="text" name="username" class="form-control" placeholder="請輸入姓名" value="${user.username}" /></td>
            	<td><form:errors path="username" style="color:red"></form:errors></td>
            	
            </tr>
            <tr>
                <td class="text-center">身分證字號：</td>
                <td><form:input path="userid"  type="text" name="userid" class="form-control" placeholder="請輸入身分證字號" value="${user.userid}" /></td>
            ...
            <tr>
                ...
                <td><form:input path="address"  type="text" name="address" class="form-control" placeholder="請輸入地址" value="${user.address}" /></td>
                <td><form:errors path="address" style="color:red"></form:errors></td>
           
            </tr>
            <tr>
                <td class="text-center">電話：</td>
                <td><form:input path="phone"  type="text" name="phone" class="form-control" placeholder="請輸入電話" value="${user.phone}" /></td>
            ...
            <tr>
             ...
             <tr>
                ...
                <td><form:input path="deptno"  type="text" name="deptno" class="form-control" placeholder="請輸入部門" value="${user.deptno}" /></td>
