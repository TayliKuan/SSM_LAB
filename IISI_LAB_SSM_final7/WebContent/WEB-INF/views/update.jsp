    ...
    <form action="user_update.action" method="post">
        <table class="table table-striped table-sm">
            ...
            <tr>
                ...
                <td><input type="text" name="username" class="form-control" placeholder="請輸入姓名" value="${aUser.username}"></td>
            	<td><form:errors path="username" style="color:red"></form:errors></td>
            	
            </tr>
            <tr>
                <td class="text-center">身分證字號：</td>
                <td><input type="text" name="userid" class="form-control" placeholder="請輸入身分證字號" value="${aUser.userid}"></td>
            	<td><form:errors path="userid" style="color:red"></form:errors></td>
            
            </tr>
            <tr>
                <td class="text-center">性別：</td>
                <td><input type="radio" id="vehicle1" name="sex" value="男" <c:if test="${aUser.sex=='男' }">checked="checked" </c:if>>
            ...
            <tr>
                ...
                <td><input type="text" name="address" class="form-control" placeholder="請輸入地址" value="${aUser.address}"></td>
                <td><form:errors path="address" style="color:red"></form:errors></td>
           
            </tr>
            <tr>
                <td class="text-center">電話：</td>
                <td><input type="text" name="phone" class="form-control" placeholder="請輸入電話" value="${aUser.phone}"></td>
            ...
            <tr>
                ...
                value="<fmt:formatDate value='${aUser.birthday}' pattern='yyyy-MM-dd' />"> </td>
            ...
            <tr>
                ...
                value="<fmt:formatDate value='${aUser.joindate}' pattern='yyyy-MM-dd' />"></td>
