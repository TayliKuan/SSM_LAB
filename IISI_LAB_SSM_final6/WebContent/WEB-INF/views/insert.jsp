...
<body>
 <div class='wrapper'>
    ...
    <div class="container">
    <form action="user_insert.action" method="post">
        <table class="table table-striped table-sm">
            ...
            <tr>
                ...
                <td><input type="date" name="birthday" class="form-control" placeholder="請輸入生日" required></td>
            </tr>
            <tr>
                <td class="text-center" >加入日期：</td>
                <td><input type="date" name="joindate" class="form-control" placeholder="請輸入加入日期" required></td>
            </tr>
            <tr>
                <td colspan="2">
